...
// ===== Active Nav Link Highlighting (page-based) =====
...
navLinkEls.forEach(link => {
  ...
  // Match: if current page is the link target, or index matches home
  if (href === currentPage || 
      (currentPage === 'index.html' && (href === 'index.html' || href === '' || href === './' || href === '/'))) {
    link.classList.add('active');
  }
  // Update remaining #section hrefs to page URLs (fallback)
  if (href.startsWith('#') && href.length > 1 && href !== '#home') {
